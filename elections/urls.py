...
from .api_views import (
    ...
    GeneratedDocumentDownloadApiView,
    IssueVotingTokenApiView,
    TopTurnoutElectionsApiView,
)
...
urlpatterns = [
    ...
    path(
        "management/admin/database-procedures/action/",
    ...
    path(
        "api/elections/analytics/top-turnout/",
        TopTurnoutElectionsApiView.as_view(),
        name="api_top_turnout_elections",
    ),
    path(
        "api/elections/analytics/historical-trends/",
        HistoricalTrendsApiView.as_view(),
        name="api_historical_trends",
    ),
    path(
        "api/elections/<int:election_id>/results/pdf/",
        ElectionResultPdfGenerateApiView.as_view(),
        name="api_election_result_pdf_generate",
    ),
    path(
        "api/documents/<int:document_id>/download/",
        GeneratedDocumentDownloadApiView.as_view(),
        name="api_generated_document_download",
    ),
    path(
